...
(function($) {
	...
	$.jRecorder = function(options, element) {
		...
		if ($.browser.msie && Number($.browser.version) <= 8) {
			...
			var paramStr = ['<param name="movie" value="' + settings['swf_path'] + '?host=' + settings['host'] + '" />',

			'<param name="allowScriptAccess" value="always" />', '<param name="bgcolor" value="' + settings['bgcolor'] + '" />', '<param name="wmode" value="' + settings['wmode'] + '" />'];
